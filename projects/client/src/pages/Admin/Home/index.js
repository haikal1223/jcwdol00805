        ...
        <div className="w-[1140px] min-h-screen flex justify-center items-start overflow-auto ">
          ...
          <div className="w-full h-[700px] flex flex-col justify-start items-start gap-10">
            ...
            <div className="w-[100%] flex flex-col gap-2 font-ibmMed text-xl text-grey">
              ...
              <hr className="w-[100%]" />
              <div>
                <span className="text-purple">/user</span> - Manage user data
              </div>
              <div>
                <span className="text-purple">/product</span> - Manage product
                details
              </div>
              <div>
                <span className="text-purple">/category</span> - Manage product
                category data
              </div>
              <div>
                <span className="text-purple">/warehouse</span> - Manage
                warehouse location
              </div>
              <div>
                <span className="text-purple">/order</span> - Manage order
                status
              </div>
              <div>
                <span className="text-purple">/mutation</span> - Manage stock
                mutation between warehouses
              </div>
              <div>
                <span className="text-purple">/dashboard</span> - Oversee sales
                & stock condition
              </div>
            </div>
          </div>
